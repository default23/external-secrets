...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CSMProvider) DeepCopyInto(out *CSMProvider) {
	*out = *in
	in.Auth.DeepCopyInto(&out.Auth)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CSMProvider.
func (in *CSMProvider) DeepCopy() *CSMProvider {
	if in == nil {
		return nil
	}
	out := new(CSMProvider)
